...
public class ModifyNumberOfPeopleIntentHandlerTest {
	private ModifyNumberOfPeopleIntentHander handler;

	@Before
    public void setup() {
        handler = new ModifyNumberOfPeopleIntentHander();
    }
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString()
                .contains(PhrasesForAlexa.PEOPLE_WELCOME));
    }
}
